...
function start() {
  ...
  document.querySelector(".info").innerHTML = time / 1000 + "";
}
  ...
  if (isSpace) {
    if (expected !== " ") {
      const lettersToInvalidate = [
        ...document.querySelectorAll(".word.currentWord .letter:not(.correct)"),
      ];
